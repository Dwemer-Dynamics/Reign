...
public sealed class OpenRouterCatalogTests
{
    ...
    public void OpenRouterUsesExistingIsolatedSuitesAndExactReferenceImageCatalog()
    {
        ...
        string source = File.ReadAllText(Path.Combine(root, "ReignServer/src/Modules/Portraits/OpenRouterImageProvider.cs"));
        ...
        foreach (string file in new[] { "docs/agent/TESTING_TOOL_GUIDE.md", "ReignMcp/docs/tool-catalog.md", "ReignMcp/docs/security-model.md", "ReignServer/docs/server/VerificationLab.md" })
