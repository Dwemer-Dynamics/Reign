...
- `ReignModules/Reign.Core.Contracts/WarCouncil/ReignWarCouncilRules.cs`
- `ReignBetaServer/src/Modules/Platform/VerificationLab.cs`
- `reign.testing.json`
...
- Exact deployed artifact hashes: client `ReignBeta.dll` `89EB921887A2557AAC0E91489204BE45F3903DE1CEC5221606DDCD2F15C9B04E`; server `ReignBetaServer.exe` `19AE41A54A7AF649F8DFC27C11877A195B7A0B4B798153377B80E50220EA233B`. Deployment evidence and rollback boundary: `.codex-build/war-council-refinement/deployment/20260824-230038/deployment-evidence.json` and installed `server/deployment-backups/war-council-refinement-20260824-230038-89eb9218`.
